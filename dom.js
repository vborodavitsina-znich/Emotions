...
export const qInput = document.getElementById('q');
export const fBase = document.getElementById('f-base');
export const fLevel = document.getElementById('f-level');
...
export const dlgQuestionEl = document.getElementById('dlg-question');
